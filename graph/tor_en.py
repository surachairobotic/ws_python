...
def main():
    ...
    f_name = 'C:/Users/surachai_probook/Downloads/TOR_EN14.CSV'
    ...
    for i in range(1, len(list_data)):
        ...
        nSave = 'C:/Users/surachai_probook/Downloads/tor_en/all_step/' + ffname+"_"+str(i) + '.png'
        print(nSave)
        plt.savefig(nSave)
    ...
    plt.tight_layout()
    #plt.show()
    nSave = 'C:/Users/surachai_probook/Downloads/tor_en/' + ffname + '.png'
    #print(nSave)
    plt.savefig(nSave)
